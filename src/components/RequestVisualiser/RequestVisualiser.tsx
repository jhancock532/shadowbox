...
function generatePathFilters(webpages: any) {
    ...
    for (const page of webpages) {
        const firstSubdirectoryName = new URL(page.title).pathname.split(
            '/',
        )[1];
        ...
        >
            {pathFilterOptions.map((path) => (
                <option
                    ...
                    key={`filter-by-path-option--${path}`}
                >
                    {path as string}
                </option>
            ))}
        ...
        <div className={styles.container}>
            <div className="contentContainer">
                ...
                <div className={styles.lineMarkerOptions}>
                    <p className={styles.lineMarkerOptionsTitle}>
                        Marker Lines:
                    </p>
                    <div className={styles.lineMarkerOption}>
                        ...
                        >
                            ...
                            <div
                                className={styles.medianWebpageLineDemonstrator}
                            ></div>
                        </label>
                    </div>
                    ...
                    <div className={styles.lineMarkerOption}>
                        ...
                        >
                            ...
                            <div
                                className={
                                    styles.averageWebpageLineDemonstrator
                                }
                            ></div>
                        </label>
                    </div>
